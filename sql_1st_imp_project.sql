...
-- Q.2 Write a SQL query to retrive all transactions where the category is 'clothing' and the quantity
...
-- Q.3 Write a SQL query  to find the average age of customers who purchased items from the 'beauty'
--     category.
...
--Q.6 Write a SQL query to find the total number of transaction (transaction_id) made by each gender in
--    each category.
...
--Q.7 Write a SQL query to calculate the average sale for each month. find out best selling month in 
--    each year
select * from
(
select 
